"""
Cross-validation for Italian S.25.01.21 Own Funds table (Phase 4).
...
DEFAULT_EPS_SUM = 1.5
DEFAULT_EPS_DIV = 0.5
DEFAULT_INPUT = "Output_final/S250121_final.csv"

CHECK_DESCRIPTIONS = {
    "TEST_1": "R0100 = R0010 + R0020 + R0030 + R0040 + R0050 + R0060 + R0070"
    }
...
def main() -> int:
    ...
    parser.add_argument(
        "--input",
        help="Path to aggregated S.25.01.21 CSV (default: Output_final/S250121_final.csv)",
    )
    parser.add_argument(
        "--eps-sum",
        type=float,
